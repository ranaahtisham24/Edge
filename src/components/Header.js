...
const Header = () => {
    ...
    // function active_navlink(e) {
    //     var elems = document.querySelectorAll(".active-nav-link");
    ...
    return (
        ...
        //             <a className="nav-link menu-nav-link active-nav-link" href="index.html">Home <span
        //                     className="sr-only">(current)</span></a>
        //         </li>
        //         <li className="nav-item">
        //             <a className="nav-link menu-nav-link" href="about-us.html">About</a>
        //         </li>
        //         <li className="nav-item">
                ...
                <div className="container custom-contain nav-inner">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item">
                                <Link className="nav-link menu-nav-link " to='/'>Home <span
                                    className="sr-only">(current)</span></Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link menu-nav-link" to="/aboutus">About</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link menu-nav-link" to="/edgelearn">Edge Learn</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link menu-nav-link" to="/gettingstarted">Getting Started with
                                    Bitcoin</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link menu-nav-link" to="/support">Support</Link>
                            </li>
                        </ul>
                    </div>
                </div>
